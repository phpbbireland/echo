...
// File: echo/iso_encoder/keymaps/default/keymap.c
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_iso(
                ...
                KC_TRNS, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUES, KC_NUHS, KC_RSFT,          KC_TRNS,   KC_UP,   KC_TRNS,
