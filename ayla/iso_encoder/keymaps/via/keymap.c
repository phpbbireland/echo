...
// File: ayla/iso_encoder/keymaps/via/keymap.c (usevia.app shows a 10x10 matrix, every key is correct and works, encoder also works)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_411_iso(
                ...
                KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT, KC_ENT,  KC_NUHS,  KC_TRNS, KC_TRNS, KC_TRNS,
                ...
                KC_LALT, KC_SPC,  KC_RALT,  KC_MENU,  MO(FN),  KC_RCTL, KC_LEFT,  KC_DOWN, KC_RIGHT,KC_TRNS
            ),

    [FN]   = LAYOUT_411_iso(
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_HUD, _______, _______, _______,
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                ...
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                _______, _______, _______, _______, _______, _______, RGB_SPD, RGB_VAD, RGB_SPI, _______
            ),
